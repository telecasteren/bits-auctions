export const ListingsSkeleton = () => {
  ...
  title.className =
    "w-40 h-10 rounded-md bg-gray-300 dark:bg-gray-800 animate-pulse mb-6";

  const searchInput = document.createElement("div");
  searchInput.className =
    "w-full h-10 rounded-md bg-gray-300 dark:bg-gray-800 animate-pulse mb-4";
  ...
  for (let i = 0; i < 2; i++) {
    ...
    tab.className =
      "w-24 h-8 rounded-md bg-gray-300 dark:bg-gray-800 animate-pulse";
