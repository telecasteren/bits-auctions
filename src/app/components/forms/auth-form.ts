...
export const AuthForm = (isSignup = false) => {
  ...
  submitButton.className = `flex h-10 w-full items-center justify-center rounded-md bg-primary px-3 py-2 text-sm font-semibold
  text-black shadow-sm hover:shadow-lg hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring
